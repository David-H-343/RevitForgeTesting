...
const getDimensions = (objectProperties) => {
    let dimensions = [];
...
const getDimension = (objectDimensions, index) => {
    return {
        displayName: objectDimensions[index].attributeName,
        displayValue: objectDimensions[index].displayValue,
        units: objectDimensions[index].units,
    };
};
    ...
    return new Promise((resolve, reject) => {
        ...
        return new Promise((resolve) => {
            viewer.model.getProperties(dbId, (item) => {
                const items = item.properties.filter(
